...
describe('demo', () => {
    ...
    context('stub private function (bar function)', () => {
        ...
        it('should stub createFile', async () => {
            ...
            //burda createStub bır fonksıyon bız demo.bardaki calldb yi ölçmek istedik burda sadece bunu kullnarak promise olarak hata almamasını önledik calldbyi ölçtuk cunku bar fonksıyonu ıcınde result olarak onun sonucunu verdi
          
            // const callStub = sinon.stub(demo, 'callDB').resolves('callDB_stub') bunu yapamayız export edilmemiş ondan export edilmemiş birşeye inject için rewire kullandık  ve bu şekilde yaptık
