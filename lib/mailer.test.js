...
describe('mailer', () => {
    ...
    describe('sendPasswordResetEmail', () => {
        ...
        it('should sendEmail with email and body', async () => {
         await mailer.sendPasswordResetEmail('karlxxx@buena.com')
          
            expect(emailStub).to.have.been.calledWith('karlxxx@buena.com', 'Please click http://some_link to reset your password.')
